...
# Almost similar to exp_30, just adding observation noise 
# also, shorten training horizon from 140 to 80
# so now, training on 80, validating on 120 (instead of 140/60 split in exp_30)
...
n_val   = n_total - n_train   # validating on 120 points
