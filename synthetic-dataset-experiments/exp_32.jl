...
# Almost similar to exp_31, just chaning the training/validation split 
# so now, training on 100, validating on 100 (instead of 140/60 split in exp_30)
...
n_train = 100                   # training on first 100 points
n_val   = n_total - n_train   # validating on 100 points
