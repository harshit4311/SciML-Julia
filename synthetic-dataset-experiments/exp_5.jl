...
# exp_4 was just exp_1 with more samples & adapts
# this(exp_5) is same as exp_4.jl but with different HMC adaptor step size (this time, step size=0.65)
...
adaptor = AdvancedHMC.StanHMCAdaptor(AdvancedHMC.MassMatrixAdaptor(metric), AdvancedHMC.StepSizeAdaptor(0.65, integrator))
